# Parse [![Build Status](https://travis-ci.org/dtrenin7/parse.svg?branch=master)](https://travis-ci.org/dtrenin7/parse) [![API reference](https://img.shields.io/badge/godoc-reference-5272B4)](https://pkg.go.dev/github.com/dtrenin7/parse/v2?tab=doc) [![Coverage Status](https://coveralls.io/repos/github/dtrenin7/parse/badge.svg?branch=master)](https://coveralls.io/github/dtrenin7/parse?branch=master)
...
The lexers are implemented using `buffer.Lexer` in https://github.com/dtrenin7/parse/buffer and the parsers work on top of the lexers. Some subpackages have hashes defined (using [Hasher](https://github.com/dtrenin7/hasher)) that speed up common byte-slice comparisons.
...
[See README here](https://github.com/dtrenin7/parse/tree/master/css).
...
[See README here](https://github.com/dtrenin7/parse/tree/master/html).
...
[See README here](https://github.com/dtrenin7/parse/tree/master/js).
...
[See README here](https://github.com/dtrenin7/parse/tree/master/json).
...
[See README here](https://github.com/dtrenin7/parse/tree/master/xml).
